//
//  RecordingPlayViewController.m
//  SeerseeJoin
//
//  Created by 赵云锋 on 16/10/24.
...
@interface RecordingPlayViewController ()<VodPlayDelegate,VodDownLoadDelegate>
{
...
@implementation RecordingPlayViewController
...
- (void)totationDocView:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    if (self.vodplayer) {
        [self.vodplayer setFullMode:_isDocFullMode];
    }
